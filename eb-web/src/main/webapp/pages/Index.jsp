...
<div class="menu_bg">
	<div class="menu">
    	...
    	<ul class="menu_r" id="hxMenu">
        	<li v-for="temp in hxListMenu"><a v-bind:href="temp.url" v-text="temp.title"></a></li>
        </ul>
        <div class="m_ad">中秋送好礼！</div>
        <script type="text/javascript">
            const hxMenuVue=new Vue({
               el: "#hxMenu",
               data: {
                   hxListMenu: []
               },
                mounted(){
                    this.$http.post("<%=basePath %>/getHxMenus.do").then(
                        function(rs){
                            this.hxListMenu=rs.body
                        }
                    );
                }
            });
